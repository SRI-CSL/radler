...
"""// Retrieve data for {subname} subscription
    ...
    int _{subname}_maxstale = floor((_{subname}_maxperiod+_{subname}_maxlatency) / _node_rate.expectedCycleTime().toSec());
    RADL__MNG_FLAGS({subname},_in.{subname}->radl__flags,_is_stale,_tc_{subname},_{subname}_maxstale)
"""
'{sub_hooks}'
